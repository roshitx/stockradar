      ...
      <div className="hidden lg:flex lg:w-[60%] relative overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-8 lg:p-12">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl lg:text-3xl font-bold text-white">Pantau saham IDX dengan mudah</h2>
              <p className="mt-2 text-white/70">Real-time data untuk investor Indonesia</p>
            </div>
            <div className="flex gap-8">
              <div>
                <div className="text-2xl font-bold text-white">900+</div>
                <div className="text-sm text-white/60">Saham</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-white">Real-time</div>
                <div className="text-sm text-white/60">Data</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-white">Gratis</div>
                <div className="text-sm text-white/60">Selamanya</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md animate-fade-in-up opacity-0">
          <GlassCard className="p-8" elevated>
            ...
            <div className="text-center space-y-2 mb-8">
              <h1 className="text-2xl font-bold tracking-tight">Masuk ke StockRadar</h1>
              <p className="text-muted-foreground">Pantau saham IDX dengan mudah</p>
            </div>
